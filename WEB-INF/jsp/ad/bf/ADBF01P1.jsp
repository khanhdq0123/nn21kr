	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			...
			$("#btnUpdate").on("click", function(){
				location.href="/ad/bf/ADBF01/popup2?businessform_no=" + $("#businessform_no").val();
			});
			
			//삭제버튼
			$("#btnDelete").on("click", function(){
				//location.href="/ad/bf/ADBF01/deleteBusinessFormMst?businessform_no=" + $("#businessform_no").val();
				
				$.ajax({
					type: "POST",
					url: "/ad/bf/ADBF01/deleteBusinessFormMst",
