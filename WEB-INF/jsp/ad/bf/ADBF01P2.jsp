...
<%@include file="/common/include/header.jsp"%>
	...
	var startPortFlag = 1;
		...
		$(document).ready(function() {
			...
			$("#submitForm").validate({
				...
				submitHandler: function(form) {
					...
					form.action = '/ad/bf/ADBF01/updateBusinessForm';
					form.method = 'post';
					form.submit();
		...
		function fn_delFile(att_seq){
			...
			$.ajax({
				type: "POST",
				url: "/ad/bf/ADBF01/deleteBusinessFormAttach",
...
<div class="layerpop_inner" id="#">
	...
	<div class="ly_body">
		...
		<form action="#" id="submitForm" enctype="multipart/form-data">
			...
			<input type="hidden" name="businessform_no" value="${info.businessform_no}"/>
