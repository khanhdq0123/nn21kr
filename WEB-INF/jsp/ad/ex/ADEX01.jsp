...
<head>
	...
	<script type="text/javascript">
		var natlCodeList = "<c:out escapeXml="false" value="${applicationScope['GRIDCODELIST']['12000']}"/>";
		var typeCodeList = "<c:out escapeXml="false" value="${applicationScope['GRIDCODELIST']['12100']}"/>";
	</script>
	<script type="text/javascript" src="/js/ad/ex/ADEX01.js"></script>
</head>
<body class="sky">
	<!-- content_wrap -->
	<div class="content_wrap">
		<div class="history">
			...
			<div class="btn-wrap">
				...
				<input type="button" class="btn btn-primary btn-sm" value="저장[F10]" id="btnSaveAdex">
			</div>
		</div>
		<!-- product_admin -->
