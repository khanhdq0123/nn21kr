...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="/js/ad/li/ADLI01P.js"></script>
	</head>
...
<%--                                            </c:forEach>    --%>
						...
						<tr>
							...
							<td colspan="3" class="st_port_wrap">
								<input type="text" id="st_port_no" name="st_port_no" style="width:100px;" value="" readonly required />
								<input type="text" name="st_port_nm" id="st_port_nm" value="" style="width:220px;" onclick="fnSelectView(1);" required />
							</td>
						</tr>
						...
						<tr>
							...
							<td colspan="3"  class="ar_port_wrap">
								<input type="text" id="ar_port_no" name="ar_port_no" style="width:100px;" value="" readonly required />
								<input type="text" name="ar_port_nm" id="ar_port_nm" value="" style="width:220px;" onclick="fnSelectView(2);" required />
							</td>
						</tr>
						<tr>
								...
								<select id="vendor_no" name="vendor_no" required>
									<option value="">전체</option>
                                           <c:forEach var="entity" items="${vendorList}">
                                              <option value="<c:out value="${entity.vendor_no}"/>"> [<c:out value="${entity.vendor_no}"/>] <c:out value="${entity.vendor_nm}"/></option>
                                           </c:forEach>   
								</select>
							</td>
						</tr>
						...
						<tr>
							...
							<td colspan="3">
								<input type="text" name="route_nm" id="route_nm" value="" style="width: 90%;" required />
							</td>
						</tr>
