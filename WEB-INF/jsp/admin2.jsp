...
#tpromoCardOrd_layer	th, td {
   ...
   *{/* 화면 전체의 기본적인 패딩,마진 제거 */
   ...
   .dropmenu ul li:hover{/* 마우스를 올릴때 하단에 밑줄나오도록*/
    border-bottom:3px solid #2D8B3B;/* 보더 지정*/
...
.dropmenu ul li:hover li.subdropmenu:hover ul li{
	...
	/* 물류메뉴 */
	.prod-mn-wrap { padding: 10px 0;}
	.prod-mn-wrap .prod-mn { width:600px; margin-left:calc(50% - 390px);}
	.prod-mn-wrap .prod-mn ul { display: flex; margin-bottom:4px;}
	.prod-mn-wrap .prod-mn ul li { width:100%; text-align:center; padding:2px 0;}
	.prod-mn-wrap .prod-mn ul li:hover {   }
	.prod-mn-wrap .prod-mn ul li a {color:#aaa; cursor:pointer;}
	.prod-mn-wrap .prod-mn ul li a:hover {color:#fff; text-decoration:underline; }
	.prod-mn-wrap .prod-mn ul li.tit {width:100%; color:#eee; font-weight:bold; text-align:right;}
	
	
	.prod-mn-wrap .prod-mn ul li.on a{color:#fff; text-decoration:underline; }
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$(".prod-mn-wrap .prod-mn ul li").on("click",function(){
			$(".prod-mn-wrap .prod-mn ul li").removeClass("on");
			$(this).addClass("on");
		});
...
<body class="sky">
	...
	<div id="wrap">
		<!-- header -->
		<div id="header">
			<div class="header-wrap2" style="height:96px !important;">
				<h1 class="logo" style="cursor:pointer;"><a href="/home" style="display:none;">Home</a></h1>
				<div class="search-area"  style="">
					<a href="/document/receive/?menu_id=10231&screen_id=&menu_nm=받은문서&js_url=" target="mainframe">받은문서 <b class="receiveDocCnt">${receiveDocCnt}</b></a>
				...
				<div class="logoin">
					...
					<span class="name">
						...
						<c:if test="${userInfo.staff_typ eq '2'}"> [${userInfo.vendor_no}] ${userInfo.vendor_nm} 지사</c:if>
...
<!-- 					<a href="/system/tms/tmsStatus" target="mainframe">프로그램게시판</a> -->
	...
	<!-- 물류 메뉴 -->
	<div class="prod-mn-wrap">
		<div class="prod-mn">
			<ul>
				<li class="tit">InBound</li>
				<li><a href="/ve/or/VEOR07/page?menu_id=10311&amp;screen_id=VEOR07&amp;menu_nm=도착예정&amp;js_url=/ve/or/VEOR07" target="mainframe"><s:message code="ve.menu11" /></a></li>
				<li><a href="/ve/or/VEOR08/page?menu_id=10317&amp;screen_id=VEOR08&amp;menu_nm=도착현황&amp;js_url=/ve/or/VEOR08" target="mainframe"><s:message code="ve.menu12" /></a></li>
				<li><a href="/ve/or/VEOR05/page?menu_id=10319&amp;screen_id=VEOR05&amp;menu_nm=배송준비&amp;js_url=/ve/or/VEOR05" target="mainframe"><s:message code="ve.menu13" /></a></li>
				<li><a href="/ve/or/VEOR06/page?menu_id=10320&amp;screen_id=VEOR06&amp;menu_nm=배송현황&amp;js_url=/ve/or/VEOR06" target="mainframe"><s:message code="ve.menu14" /></a></li>
			</ul>
			<ul>
				<li class="tit">OutBound</li>
				<li><a href="/ve/or/VEOR01/page?menu_id=10245&amp;screen_id=VEOR01&amp;menu_nm=접수현황&amp;js_url=/ve/or/VEOR01" target="mainframe"><s:message code="ve.menu15" /></a></li>
				<li><a href="/ve/or/VEOR02/page?menu_id=10311&amp;screen_id=VEOR02&amp;menu_nm=입고현황&amp;js_url=/ve/or/VEOR02" target="mainframe"><s:message code="ve.menu16" /></a></li>
				<li><a href="/ve/or/VEOR03/page?menu_id=10315&amp;screen_id=VEOR03&amp;menu_nm=발송준비&amp;js_url=/ve/or/VEOR03" target="mainframe"><s:message code="ve.menu17" /></a></li>
				<li><a href="/ve/or/VEOR04/page?menu_id=10317&amp;screen_id=VEOR04&amp;menu_nm=출고현황&amp;js_url=/ve/or/VEOR04" target="mainframe"><s:message code="ve.menu18" /></a></li>
			</ul>
		</div>
		
		<div class="search-wrap" >
			<form action="/partner/partnerList" target="mainframe" id="sForm" namd="sForm" method="get" > 
				<input type="hidden" name="menu_id" value="10184" />
				<input type="hidden" name="menu_nm" value="고객현항" />
				<input type="hidden" name="screen_id" value="" />
<!-- 				<span style="color:#fff; margin-right:5px;">고객검색</span>  -->
				<input type="text" name="search_str" placeholder="고객번호 or 상호명 or 전화번호" style="width:280px;"  />
				<input type="button" class="btn btn-success btn-xs" value="고객검색" id="btnSearchCustomer" onclick="$('#sForm').submit();">
			</form>
		</div>
