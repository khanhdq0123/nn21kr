...
#tpromoCardOrd_layer	th, td {
   ...
   *{/* 화면 전체의 기본적인 패딩,마진 제거 */
   ...
   .dropmenu ul li:hover{/* 마우스를 올릴때 하단에 밑줄나오도록*/
    border-bottom:3px solid #2E8AD1;/* 보더 지정*/
			...
			<div class="header-wrap3">
				...
				<div class="logoin">
					...
					<span class="name">
						...
						<c:if test="${userInfo.staff_typ eq '3'}">[${userInfo.vendor_no}] ${userInfo.vendor_nm}</c:if>
