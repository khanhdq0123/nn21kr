	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			...
			$("#btnUpdate").on("click", function(){
				location.href="/cu/bf/CUBF01/popup2?businessform_no=" + $("#businessform_no").val();
			});
			
			//삭제버튼
			$("#btnDelete").on("click", function(){
				//location.href="/cu/bf/CUBF01/deleteBusinessFormMst?businessform_no=" + $("#businessform_no").val();
				
				$.ajax({
					type: "POST",
					url: "/cu/bf/CUBF01/deleteBusinessFormMst",
...
<div class="layerpop_inner" id="#">
	...
	<div class="ly_body">
		...
		<form action="#" id="submitForm" enctype="multipart/form-data">
			...
			<input type="hidden" name="businessform_no" id="businessform_no" value="${info.businessform_no}"/>
