...
<form method="post" id="rForm" name="rForm">
	<input type="hidden" id="vendor_no" 	name="vendor_no" 		value="" />
							...
							<caption>${pTitle} 정보</caption>
								...
								<tbody>
									<tr>
										...
										<td colspan="3">
											<input type="text" id="vendor_cd1" name="vendor_cd1" value="" style="width:40px" class="b" maxlength="2" />
											<input type="text" id="vendor_cd2" name="vendor_cd2" value="" style="width:100px" class="b readonly" maxlength="7" readonly />
											<input type="button" class="btn btn-success btn-xs" value="Check Code" onclick="fnCheckVendorCode();">
										</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td colspan="3">				
											<input type="text" id="basadd_txt" name="basadd_txt" value="" onclick="fnSelectRegionPop(1);" class="readonly" style="width:92%;" placeholder="여기를 눌러 선택하세요." readonly/> <br />
											<input type="text" id="dtladd_txt" name="dtladd_txt" value="" style="width:92%; margin-top:2px;" maxlength="150" placeholder="여기에 상세주소를 입력하세요." required />
										</td>
									</tr>
									...
									<tr>
										...
										<td colspan="3">	
											...
											<input type="text" id="road_basadd_txt" name="road_basadd_txt" value="" onclick="fnSelectRegionPop(2);" class="readonly" style="width:78%;" placeholder="여기를 눌러 선택하세요." readonly/> <br />
											<input type="text" id="road_dtladd_txt" name="road_dtladd_txt" value="" style="width:92%; margin-top:2px;" maxlength="150" placeholder="여기에 상세주소를 입력하세요." required />
										</td>
									</tr>
							...
							<table cellspacing="0" cellpadding="0" summary="" class="layer_tbl mb20" style="border-bottom: 30px;">
								...
								<tbody>
									...
									<tr>
										<th scope="row"><span class="starMark">필수입력 항목입니다.</span>영문</th>
										<td>
											<input type="text" id="staff_enm3" name="staff_enm3" value="<c:out value='${staff.staff_enm}'/>" style="width:90%" maxlength="30" />
										</td>
										<th scope="row"><span class="starMark">필수입력 항목입니다.</span>핸드폰</th>
										<td>
											<input type="text" id="mobile_txt3" name="mobile_txt3" value="<c:out value='${staff.mobile_txt}'/>" style="width:90%" maxlength="30" />
										</td>							
									</tr>
									<tr>
										<th scope="row"><span class="starMark">필수입력 항목입니다.</span>한글</th>
										<td>
											<input type="text" id="staff_nm3" name="staff_nm3" value="<c:out value='${staff.staff_nm}'/>" style="width:90%" maxlength="30" />
										</td>
										<th scope="row"><span class="starMark">필수입력 항목입니다.</span>이메일</th>
										<td>
											<input type="text" id="email_txt3" name="email_txt3" value="<c:out value='${staff.email_txt}'/>" style="width:90%" maxlength="30" />
										</td>							
									</tr>
									<tr>
										<th scope="row"><span class="starMark">필수입력 항목입니다.</span>아이디</th>
										<td>
											<input type="text" id="login_id3" name="login_id3" value="<c:out value='${staff.login_id}'/>" style="width:150px;" maxlength="30"/>
											<input type="button" class="btn btn-success btn-xs" id="btnDup3" value="중복확인">
										</td>
										<th scope="row"></th>
										<td>
										</td>							
									...
									<tr>
										<th scope="row"><span class="starMark">필수입력 항목입니다.</span>비번</th>
										<td>
											<input type="password" id="passwd_txt3" name="passwd_txt3" value="" style="width:90%" maxlength="30"/>
										</td>
										<th scope="row"><span class="starMark">필수입력 항목입니다.</span>비번확인</th>
										<td>
											<input type="password" id="passwd_txt32" name="passwd_txt32" value="" style="width:90%" maxlength="30"/>
										</td>							
									</tr>
								</tbody>
							</table>
