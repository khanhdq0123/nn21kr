...
<script type="text/javascript">
	$(document).ready(function() {
		...
		// 그리드 
		jQuery("#list1").jqGrid({
			url: "/document/sentDocListJson",
			datatype: "local",
		   	colNames: ['제목','수신처','수신인','등록 일시'],
			colModel: [
				...
				{ name: 'reg_dt',	index: 'reg_dt',		align: 'center', sortable: true, width: '120' }
			],
			autowidth: true,
			height: 500,
// 			pager: '#pager1',
...
<body class="sky">
	...
	<div class="content_wrap">
		<div class="history">
			<h3 class="header">보낸문서</h3>
			
			<span class="bullet6">문서관리 &gt; 보낸문서</span>
		</div>
		<!-- product_admin -->
