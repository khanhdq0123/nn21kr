				...
				$.ajax({
					...
					success: function(data) {
						if(data.code == '0') {
								...
								location.href = "/join/joinMembership5?vendor_no=" + data.vendor_no;
								//self.close();
								...
								<tbody>
									...
									<tr class="division" style="height:50px;vertical-align:bottom;">
										<td colspan="4"><h3>등록인 정보</h3>
											...
											<label for="chkSame2">*등록인이 대표자와 동일한 경우 첵크하세요</label> 
											<input type="checkbox" name="chkSame2" id="chkSame2" value="1" />
											</div>
										</td>
									</tr>
									...
									<tr class="staffWrap">
										<th scope="row"><span class="starMark">필수입력 항목입니다.</span>영문</th>
										<td>
											<input type="text" id="staff_enm" name="staff_enm" value="" style="width:90%" maxlength="30" required />
										</td>
										<th scope="row"><span class="starMark">필수입력 항목입니다.</span>핸드폰</th>
										<td>
									...
									<tr class="staffWrap">
										<th scope="row">한글</th>
										<td>
											<input type="text" id="staff_nm" name="staff_nm" value="" style="width:90%" maxlength="30" />
										</td>
										<th scope="row"><span class="starMark">필수입력 항목입니다.</span>이메일</th>
										<td>
											<input type="text" id="email_txt" name="email_txt" value="" style="width:90%" maxlength="30" required />
										</td>							
									</tr>
									<tr class="staffWrap">
										<th scope="row"><span class="starMark">필수입력 항목입니다.</span>아이디</th>
