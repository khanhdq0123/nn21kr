...
<script type="text/javascript">
	$(document).ready(function() {
		// 그리드 
		jQuery("#list1").jqGrid({
			url: "/notice/admNoticeListJson",
			datatype: "local",
		   	colNames: ['제목','등록인','지사(업체명)','등록 일시'],
			colModel: [
				...
				{ name: 'vendor_nm', index: 'vendor_nm', align: 'center', sortable: true, width: '200' }, 
...
// 			},
		...
		function linkFormatter(cellVal, options, rowObj) {
			var linkURL = '<a href="javascript:CenterOpenWindow(\'/notice/admNoticeDetailView?id='
					+ rowObj['adm_notice_no']
		...
		$("#btnNewPost").click(function() {
			...
			var params = "?mode=new"
			CenterOpenWindow("/notice/admNoticeDetail" + params, "_blank", width, height, "scrollbars=yes, status=no");
		});
