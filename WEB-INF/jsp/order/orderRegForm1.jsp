				...
				<div class="ui-jqgrid ui-widget ui-widget-content ui-corner-all" style="padding:5px;">
					...
					<div class="tbl_wrap">
						...
						<dl class="section">
							<dt>출발지사</dt>
							<dd class="cols" style="width:280px;">
								<input type="text" id="start_vendor_nm" name="start_vendor_nm" class="readonly" placeholder="출발지사선택" onclick="fnSelectLayer('출발지사 선택','selectVendorLayerPop','start_vendor_no','start_vendor_nm'); " style="width:98%;" readonly />
							</dd>
							<dt>도착지사</dt>
							<dd class="cols" style="width:280px;">
								<input type="text" id="arrive_vendor_nm" name="arrive_vendor_nm" class="readonly" placeholder="도착지사선택" onclick="fnSelectLayer('도착지사 선택','selectVendorLayerPop','arrive_vendor_no','arrive_vendor_nm');" style="width:98%;" readonly />
							</dd>
							<dt>경유지사</dt>
							<dd class="cols" style="width:280px;">
								<input type="text" id="transfer_vendor_nm" name="transfer_vendor_nm" class="readonly" placeholder="경유지사선택" onclick="fnSelectLayer('경유지사 선택','selectVendorLayerPop','transfer_vendor_no','transfer_vendor_nm');" style="width:98%;" readonly />
							</dd>
						</dl>
					</div>
				</div>
