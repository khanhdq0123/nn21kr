...
//				datatype: "json",				   
				datatype: "local",				   
				colNames:['등록일시',titVendorNm + ' 코드', '고객번호', '상호', '주소', '연락처', '업체상태'],
				colModel:[
					...
					{name:'vendor_cd',		index:'vendor_cd',		width:80,	align:"center",	sortable:true}, //고객번호
...
// 			});
			...
			function partnerLinkFormatter(cellVal, options, rowObj) {
				var linkURL = '<a href="javascript:CenterOpenWindow(\'/partner/partnerDetail.do?vendor_no=' + rowObj['vendor_no'] + '\', \'open\', \'1200\', \'800\', \'scrollbars=yes, status=no\');">'+cellVal+'</a>';										
				return linkURL;
			}
