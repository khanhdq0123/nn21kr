...
<%-- 										<td colspan="3"><input type="text" id="item_txt" name="item_txt" value="${info.item_txt}" onclick="fnViewItemLayer();" style="width:80%;" class="readonly" maxlength="30" required readonly /></td> --%>
	    	...
	    	<div class="tapcont dpn">
	    		...
	    		<div style="text-align:center; padding:30px;">
					<input type="button" class="btn btn-primary btn-sm" value="SAVE" id="btnSave1">
				</div>
	    	...
	    	<div class="tapcont dpn">
				...
				<table cellspacing="0" cellpadding="0" summary="" class="layer_tbl" style="border-top: 0px;">
					...
					<tbody>
						...
						<tr>
							...
							<td colspan="3">
								 <c:forEach var="sns2" items="${staff2SnsList}">
								 	<span>${sns2.sns_typ_nm} : ${sns2.sns_id}</span>
								 	<input type="button" class="btn btn-close btn-xs"  onclick="fnDelSns('${sns1.staff_sns_seq}');" value="삭제">
								 </c:forEach>   
							</td>
						</tr>
	    		...
	    		<div style="text-align:center; padding:30px;">
					<input type="button" class="btn btn-primary btn-sm" value="SAVE" id="btnSave2">
				</div>	
				...
				<c:forEach var="staff" items="${staffList}">
							<table cellspacing="0" cellpadding="0" summary="" class="layer_tbl mb20" style="border-bottom: 30px;">
								...
								<tbody>
									...
									<tr>
										<th scope="row">SNS정보
											<input type="button" class="btn btn-primary btn-xs addSnsBtn" value="추가">
										</th>
										<td colspan="3">
							...
							<div style="text-align:center; padding: 0 0 40px;">
								<input type="button" class="btn btn-primary btn-xs" value="등록" id="">
								<input type="button" class="btn btn-danger btn-xs" value="삭제" id="">
							</div>	
