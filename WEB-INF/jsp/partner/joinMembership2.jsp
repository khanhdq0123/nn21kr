					...
					$.ajax({
						...
						success: function(data) {
							if(data.code == '0') {
									...
									location.href = "/partner/joinMembership3?vendor_no=" + data.vendor_no;
									//self.close();
	...
	<div class="layerpop_inner"  id="partnerPop">
		...
		<div class="ly_body">
			<div class="refer bullet6">
				<h1 class="fl fs16" onclick="fnTest();">국제종합물류주식회사 회원등록</h1>
				<div class="refer_bt" >
...
<!-- 									</tr> -->
									...
									<tr>
										...
										<td colspan="3">				
											<input type="text" id="basadd_txt" name="basadd_txt" value="${info.basadd_txt}" onclick="fnSelectRegionPop(1);" class="readonly" style="width:62%;" placeholder="여기를 눌러 선택하세요." required readonly/>
...
<!-- 											<input type="button" class="btn btn-info btn-sm" value="SAVE" id="BTN_SetSave">		 -->
								...
								<c:if test="${sessionScope['STAFFINFORMATION']['staff_typ'] eq '2'}">
									<tr>
										...
										<td colspan="3"><input type="text" id="business_type_txt" name="business_type_txt" value="${info.business_type_txt}" class="readonly" onclick="fnViewBusinessTypeLayer();" style="width:80%" maxlength="30" readonly /></td>
									</tr>
									
									<tr>
										<th scope="row"><label for="business_txt">업종</label></th>
										<td colspan="3"><input type="text" id="business_txt" name="business_txt" value="${info.business_txt}" class="readonly" onclick="fnViewBusinessTypeLayer();" style="width:80%" maxlength="30" readonly /></td>
									</tr>
	
									<tr>
										<th scope="row"><label for="business_txt">품목</label></th>
										<td colspan="3"><input type="text" id="item_txt" name="item_txt" value="${info.item_txt}" onclick="fnViewItemLayer();" style="width:80%;" class="readonly" maxlength="30" readonly /></td>
									</tr>
								</c:if>
