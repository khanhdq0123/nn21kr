...
<head>
	...
	var vendor_nm = '${info.vendor_nm}';
		...
		$(document).ready(function() {
			...
			var submitUrl = "/partner/insertParnterInfo";	//거래처등록
			if('${info.vendor_no}') {
					...
					$.ajax({
						...
						success: function(data) {
							...
							if(data.code == '0') {
								...
								var _html = '<li cd="' + data.vendor_no + '" nm="[' + data.vendor_no + '] ' + data.vendor_nm + '"><b>[' + data.vendor_no + '] ' + data.vendor_nm + '</b> : ' + data.basadd_txt + '</li>';

								opener.fnAddCoopComp($("#vendor_typ").val(), _html);
			...
			<div class="layer_contents">
				<div class="inb_con active">
					<form method="post" id="partnerForm" >
						<input type="hidden" id="upvendor_no" 	name="upvendor_no" 		value="${vendorInfo.upvendor_no}" />
						<input type="hidden" id="upvendor_nm" 	name="upvendor_nm" 		value="${vendorInfo.upvendor_nm}" />
