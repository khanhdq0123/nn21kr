			...
			<div class="layer_contents">
				<div class="inb_con active">
					<form method="post" id="partnerForm" name="partnerForm">
						<input type="hidden" id="upvendor_no" 	name="upvendor_no" 		value="${upvendor_no}" />
						<input type="hidden" id="upvendor_nm" 	name="upvendor_nm" 		value="${upvendor_nm}" />
...
<!-- 											<input type="button" class="btn btn-primary btn-sm" value="주소검색" id="btnSearchAddr" onclick="fnSearchPost()">	 -->
											...
											<input type="text" id="road_dtladd_txt" name="road_dtladd_txt" value="${info.road_dtladd_txt}" style="width:32%; margin-top:2px;" maxlength="150" placeholder="여기에 상세주소를 입력하세요." required />
										</td>
									</tr>
									...
									<tr>
										...
										<td colspan="3"><input type="text" id="item_txt" name="item_txt" value="${info.item_txt}" style="width:80%;" /></td>
									</tr>
