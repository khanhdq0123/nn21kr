	...
	function fnRegionNationLoad(code){
		...
		$.ajax({
			...
			success: function(data) {
				...
				regionHtml +="<tr><th>";
				regionHtml +="<button id=\"btnMod2\" name=\"btnMod2\" class=\"sky\" onclick=\"fnRegRegion(20000, 1);\" style=\"margin-top:0; width:230px;\">+ 대륙추가</button></th>";
				regionHtml +="<td>";
				regionHtml +="</td></tr>";
			...
			success: function(data) {
				...
				$.each(data.rows, function(key, d) {
					...
					if(beforeUpcode != d.up_code){						
						...
						regionHtml += "<span onclick=\"fnRegionDetailPop('" + d.up_code + "',4)\">" + d.up_region_nm + "</span>";
						regionHtml += "<div class='mt5'>";
...
// 				regionHtml +="</td></tr>";
	...
	function fnPreView(){
		CenterOpenWindow('/region/selectRegionPop?code=20000', '육상포트선택', '1000','560', 'scrollbars=no, status=yes');
	}
