			...
			success: function(data) {
				...
				$.each(data.rows, function(key, d) {
					...
					if(beforeUpcode != d.up_code){						
						...
						regionHtml += "<span class='mb10' onclick=\"fnRegionDetailPop('" + d.up_code + "',2)\">" + d.up_region_enm + "</span>";
// 						if(d.up_region_nm != null && d.up_region_nm != '')
// 						regionHtml += "<br /><span class='mb10' onclick=\"fnRegionDetailPop('" + d.up_code + "',2)\">" + d.up_region_nm + "</span>";
			...
			success: function(data) {
				...
				$.each(data.rows, function(key, d) {
					...
					if(d.region_nm != null){
						...
						regionHtml += "<span class=\"tit\" onclick=\"fnRegionVillageLoad('" + d.code + "','" + d.region_enm + "','" + d.region_nm + "')\">" + d.region_enm + " " + d.region_nm + "</span>";
	...
	function fnRegionVillageLoad(code,region_enm,region_nm){
		...
		$.ajax({
			...
			success: function(data) {
				...
				regionHtml += "<span onclick=\"fnRegionLoad('" + code + "','" + region_enm + "')\">" + region_enm + "</span>";
				if(region_nm != null && region_nm != '')
				regionHtml += "<br /><span onclick=\"fnRegionLoad('" + code + "','" + region_nm + "')\">" + region_nm + "</span>";
				regionHtml += "<br /><span class='minBtn'><span class='' onclick=\"fnRegRegion('" + code + "',5);\">지역등록</span></span>";
				regionHtml += "</th>";
				...
				$.each(data.rows, function(key, d) {
					regionHtml += "<span class=\"nation\">";
					regionHtml += "<span class=\"tit\" onclick=\"fnRegionVillageLoad2('" + d.code + "','" + d.region_enm + "','" + d.region_nm + "')\">" + d.region_enm + " " + d.region_nm + "</span>";
...
// 				regionHtml +="</td></tr>";
	...
	function fnRegionVillageLoad2(code,region_enm,region_nm){
		...
		$.ajax({
			...
			success: function(data) {
				...
				if(region_nm != null && region_nm != '')
					regionHtml += "<br /><span onclick=\"fnRegionLoad('" + code + "','" + region_nm + "')\">" + region_nm + "</span>";
				regionHtml += "<br /><span class='minBtn'><span class='' onclick=\"fnRegRegion('" + code + "',6);\">지역등록</span></span>";
				regionHtml += "</th>";
				...
				$.each(data.rows, function(key, d) {
					regionHtml += "<span class=\"nation\">";
					regionHtml += "<span class=\"tit\" onclick=\"fnRegionVillageLoad3('" + d.code + "','" + d.region_enm + "','" + d.region_nm + "')\">" + d.region_enm + " " + d.region_nm + "</span>";
	...
	function fnRegionVillageLoad3(code,region_enm,region_nm){
		...
		$.ajax({
			...
			success: function(data) {
				...
				if(region_nm != null && region_nm != '')
				regionHtml += "<br /><span onclick=\"fnRegionLoad('" + code + "','" + region_nm + "')\">" + region_nm + "</span>";
				regionHtml += "<br /><span class='minBtn'><span class='' onclick=\"fnRegRegion('" + code + "',7);\">지역등록</span></span>";
				regionHtml += "</th>";
				...
				$.each(data.rows, function(key, d) {
					regionHtml += "<span class=\"nation\">";
					regionHtml += "<span class=\"tit\" onclick=\"fnRegionVillageLoad4('" + d.code + "','" + d.region_enm + "','" + d.region_nm + "')\">" + d.region_enm + " " + d.region_nm + "</span>";
					regionHtml += "<span class='minBtn'><span class='' onclick=\"fnRegionDetailPop('" + d.code + "',7)\">수정</span></span>";
					regionHtml += "</span>";
				});
	...
	function fnRegionVillageLoad4(code,region_enm,region_nm){
		...
		$.ajax({
			...
			success: function(data) {
				...
				if(region_nm != null && region_nm != '')
				regionHtml += "<br /><span onclick=\"fnRegionLoad('" + code + "','" + region_nm + "')\">" + region_nm + "</span>";
				regionHtml += "<br /><span class='minBtn'><span class='' onclick=\"fnRegRegion('" + code + "',8);\">지역등록</span></span>";
				regionHtml += "</th>";
				...
				$.each(data.rows, function(key, d) {
					...
					regionHtml += "<span class='minBtn'><span class='' onclick=\"fnRegionDetailPop('" + d.code + "',8)\">수정</span></span>";
					regionHtml += "</span>";
				});
...
// 				regionHtml +="</td></tr>";
	...
	function fnRegionVillageLoad5(code,region_nm,sort_seq,cnt){
		_region4 = region_nm;
		_region4No = code;
		$("#selectRegionTxt").text($("#selectRegionTxt").text() + ' > ' + region_nm);
	}
	...
	function fnCallbackRegionUpdate(levels){
		...
		if(levels == '1' || levels == '2'){
			...
			fnRegionVillageLoad3(_region2No,_region2);
		}
		else if(levels == '8'){
			fnRegionVillageLoad4(_region3No,_region3);
		}
	}

	//등록 화면
	function fnRegRegion(code, levels){
		CenterOpenWindow('/region/regionRegFormPop?code='+ code + '&levels=' + levels, '지역등록', '680','360', 'scrollbars=no, status=yes');
	}
	
	//수정 화면
	function fnRegionDetailPop(code, levels){
		CenterOpenWindow('/region/regionDetailPop?code='+ code + '&levels=' + levels, '지역등록', '680','360', 'scrollbars=no, status=yes');
	}
