...
<div class="layerpop_inner" id="#">
	<h1 class="ly_header">${mode == "new" ? "지사 게시판 등록 페이지" : "지사 게시판 상세 페이지"}</h1>
	<!-- .ly_body -->
	<div class="ly_body">
		...
		<form action="#" id="submitForm" enctype="multipart/form-data">
			<fieldset>
			<legend>${mode == "new" ? "지사 게시판 등록 페이지" : "지사 게시판 상세 페이지"}</legend>
			...
			<div class="layer_contents">
				...
				<caption>${mode == "new" ? "지사 게시판 등록 페이지" : "지사 게시판 상세 페이지"}</caption>
					<colgroup>
						<col width="15%"/>
						<col width="20%"/>
						<col width="15%"/>
