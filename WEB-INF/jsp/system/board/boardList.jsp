...
// 			rowList: [20, 50, 100],
	...
	// 		multiselect: true,
		...
		function linkFormatter(cellVal, options, rowObj) {
			...
			var linkURL = '<a href="javascript:CenterOpenWindow(\'/system/board/sysBoardDetail' + params + '&id='
					+ rowObj['board_no']
		...
		$("#btnNewPost").click(function() {
			...
			var params = "?mode=new"
			CenterOpenWindow("/system/board/sysBoardDetail" + params, "_blank", width, height, "scrollbars=yes, status=no");
		});
...
<body class="sky">
	...
	<div class="content_wrap">
		<div class="history">
			<h3 class="header">관리자 게시판</h3>
			
			<span class="bullet6">시스템관리 &gt; 관리자 게시판</span>
		</div>
		<!-- product_admin -->
		<div class="product_admin">
			...
			<div class="product_form">
				...
				<input type="hidden" name="board_typ" id="board_typ" value="1" />
				
					<fieldset>
						<legend>관리자 게시판</legend>
