	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			...
			$("#btnUpdate").on("click", function(){
				location.href="/ve/bf/VEBF01/popup2?businessform_no=" + $("#businessform_no").val();
			});
			
			//삭제버튼
			$("#btnDelete").on("click", function(){
				//location.href="/ve/bf/VEBF01/deleteBusinessFormMst?businessform_no=" + $("#businessform_no").val();
				
				$.ajax({
					type: "POST",
					url: "/ve/bf/VEBF01/deleteBusinessFormMst",
