...
<input type="hidden" name="board_cate_typ" 		id="board_cate_typ" value="1" />
	...
	<div class="content_wrap">
		...
		<div class="product_admin">
			...
			<div class="radio-group">
                <div class="option"><input type="radio" id="rd_vedc01" name="rd_vedc" value="1" checked="checked"><label class="radio-container" for="rd_vedc01">회사보드관리</label></div>
