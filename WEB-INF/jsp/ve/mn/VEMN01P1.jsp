	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			...
			$("#btnUpdate").on("click", function(){
				location.href="/ve/mn/VEMN01/popup2?manual_no=" + $("#manual_no").val();
			});
			
			//삭제버튼
			$("#btnDelete").on("click", function(){
				//location.href="/ve/mn/VEMN01/deleteManualMst?manual_no=" + $("#manual_no").val();
				
				$.ajax({
					type: "POST",
					url: "/ve/mn/VEMN01/deleteManualMst",
