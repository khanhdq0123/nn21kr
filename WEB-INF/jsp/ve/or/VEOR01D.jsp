...
// 			}
			...
			$("#btnEdit").on("click", function(){
				...
				CenterOpenWindow('/ve/or/VEOR01/popup1?ord_no=' + ord_no + '&inout_typ' + inout_typ, '견적접수 등록', '1280','1024', 'scrollbars=no, status=yes');
					...
					<caption>Shipper</caption>
						...
						<tbody>
							...
							<tr>
								...
								<td id="tdShipperFile" class="addD2">
				...
				<div class="ui-jqgrid ui-widget ui-widget-content ui-corner-all" style="padding:5px;">
					...
					<caption>Consignee</caption>
						...
						<tbody>
							...
							<tr>
								<th scope="row">등록문서</th>
								<td id="tdConsigneeFile"  class="addD2">
...
<!-- 				</div> -->
			...
			<div style="width:49%; float:right; position:relative;">
				<h1 class="styleH3">최근거래내역</h1>
				<div class="grid">
					<table id="recentOrdTtemList"></table>
				</div>
