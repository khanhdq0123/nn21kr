...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>접수 등록</title>
		<script type="text/javascript" src="/js/ve/or/VEOR01P1.js?123"></script>
					...
					<div class="tbl_wrap">
						...
						<dl class="section">
							...
							<dd class="cols" style="width:280px;">
								<input type="text" id="shipping_region_nm" name="shipping_region_nm" value="${info.shipping_region_nm}" class="readonly" placeholder="선적지점선택" style="width:98%;"  onclick="fnSelectRegionPop(1);" readonly />
							</dd>
							<dt>출발지점</dt>
							<dd class="cols" style="width:280px;">
								<input type="text" id="send_region_nm" name="send_region_nm" class="readonly" value="${info.send_region_nm}" placeholder="출발지점선택" style="width:98%;" onclick="fnSelectRegionPop(2);" readonly />
							</dd>
							<dt>도착지점</dt>
							<dd class="cols" style="width:280px;">
								<input type="text" id="receive_region_nm" name="receive_region_nm" class="readonly" value="${info.receive_region_nm}" placeholder="도착지점선택" style="width:98%;" onclick="fnSelectRegionPop(3);" readonly />
							</dd>
						</dl>
				...
				<div class="ui-jqgrid ui-widget ui-widget-content ui-corner-all" style="padding:5px;">
					...
					<div class="tbl_wrap">
						...
						<dl class="section">
							<dt>출발지사</dt>
							<dd class="cols" style="width:280px;">
								<input type="text" id="start_vendor_nm" name="start_vendor_nm" value="${info.start_vendor_nm}"  class="readonly" placeholder="출발지사선택" onclick="fnSelectLayer1('출발지사 선택','selectVendorLayerPop','start_vendor_no','start_vendor_nm'); " style="width:98%;" readonly />
							</dd>
							<dt>도착지사</dt>
							<dd class="cols" style="width:280px;">
								<input type="text" id="arrive_vendor_nm" name="arrive_vendor_nm" value="${info.arrive_vendor_nm}"  class="readonly" placeholder="도착지사선택" onclick="fnSelectLayer1('도착지사 선택','selectVendorLayerPop','arrive_vendor_no','arrive_vendor_nm');" style="width:98%;" readonly />
							</dd>
							<dt>경유지사</dt>
							<dd class="cols" style="width:280px;">
								<input type="text" id="transfer_vendor_nm" name="transfer_vendor_nm" value="${info.transfer_vendor_nm}"  class="readonly" placeholder="경유지사선택" onclick="fnSelectLayer1('경유지사 선택','selectVendorLayerPop','transfer_vendor_no','transfer_vendor_nm');" style="width:98%;" readonly />
							</dd>
						</dl>
					</div>
				</div>
					...
					<caption>Shipper</caption>
						...
						<tbody>
							<tr>
								...
								<td>
									<input type="text" id="send_nm" name="send_nm" value="${info.send_nm}"  class="readonly" placeholder="발송화주선택" onclick="fnSelectLayer2('발송화주 선택','selectCustomerLayerPop','send_no','send_nm'); " style="width:68%;" readonly />
									<input type="button" class="btn btn-primary btn-xs" value="new" id="btnCompReg1" onclick="cfCoopCompReg(3);">
								</td>							
							</tr>
							<tr>
								<th scope="row">수출회사</th>
								<td>
									<input type="text" id="send_trade_comp_nm" name="send_trade_comp_nm" value="${info.send_trade_comp_nm}"  class="readonly" placeholder="수출회사선택" onclick="fnSelectLayer3('수출회사 선택','selectTradeCompLayerPop','send_trade_comp_no','send_trade_comp_nm'); " style="width:68%;" readonly />
							...
							<tr>
								...
								<td>
									<input type="text" id="send_cc_comp_nm" name="send_cc_comp_nm" value="${info.send_cc_comp_nm}"  class="readonly" placeholder="수출통관회사선택" onclick="fnSelectLayer3('수출통관회사 선택','selectCCCompLayerPop','send_cc_comp_no','send_cc_comp_nm'); " style="width:68%;" readonly />
					...
					<caption>Consignee</caption>
						...
						<tbody>
							<tr>
								...
								<td>
									<input type="text" id="receive_nm" name="receive_nm" value="${info.receive_nm}"  class="readonly" placeholder="발송화주선택" onclick="fnSelectLayer2('수화화주 선택','selectCustomerLayerPop','receive_no','receive_nm'); " style="width:68%;" readonly />
									<input type="button" class="btn btn-primary btn-xs" value="new" id="btnCompReg4" onclick="cfCoopCompReg(3);">
								</td>							
							</tr>
							<tr>
								<th scope="row">수입회사</th>
								<td>
									<input type="text" id="receive_trade_comp_nm" name="receive_trade_comp_nm" value="${info.receive_trade_comp_nm}"  class="readonly" placeholder="수입회사선택" onclick="fnSelectLayer3('수입회사 선택','selectTradeCompLayerPop','receive_trade_comp_no','receive_trade_comp_nm'); " style="width:68%;" readonly />
							...
							<tr>
								...
								<td>
									<input type="text" id="receive_cc_comp_nm" name="receive_cc_comp_nm" value="${info.receive_cc_comp_nm}"  class="readonly" placeholder="수입통관회사선택" onclick="fnSelectLayer3('수입통관회사 선택','selectCCCompLayerPop','receive_cc_comp_no','receive_cc_comp_nm'); " style="width:68%;" readonly />
...
<div class="layer-mask" style="display:none;"></div>
	...
	<!-- 통관회사 선택 -->
	<div class="lypopWrap" style="width:780px; max-height:400px; overflow-y:auto; display:none; " id="selectCCCompLayerPop" >
		<div class="header">
	...
	<!-- 지사선택 -->
	<div class="lypopWrap" style="width:780px; max-height:400px; overflow-y:auto; display:none; " id="selectVendorLayerPop"  data-typ='' >
		<div class="header">
