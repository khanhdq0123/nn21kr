	$(document).ready(function() {
		...
		// 그리드 - 프로토타입 
		jQuery('#list1').jqGrid({
			url: '/ad/bf/ADBF01/selectBusinessFormList',
			datatype: 'local',
...
// 	        }
		...
		function linkFormatter(cellVal, options, rowObj) {
			var linkURL = '<a href="javascript:CenterOpenWindow(\'/ad/bf/ADBF01/popup1' 
...
//신규등록
function fn_f9(){
	CenterOpenWindow('/ad/bf/ADBF01/popup?node=new', 'open', '1000', '640', 'scrollbars=yes, status=no');
}

//저장
function fn_f10(){
	saveGridSelected("list1", 'selected', 'save', "/ad/bf/ADBF01/update");
}

//삭제
function fn_f11(){
	saveGridSelected("list1", 'selected', 'delete', "/ad/bf/ADBF01/delete");
}
