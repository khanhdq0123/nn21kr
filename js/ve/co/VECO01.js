...
//				datatype: "json",				   
				datatype: "local",				   
				colNames:[' 코드',  '상호', '주소', '연락처','등록일시'],
				colModel:[
					{name:'vendor_cd',		index:'vendor_cd',		width:40,	align:"center",	sortable:true},
...
//			});
		...
		function partnerLinkFormatter(cellVal, options, rowObj) {
			var linkURL = '<a href="javascript:CenterOpenWindow(\'/partner/coopCompPop?vendor_typ=3&vendor_no=' + rowObj['vendor_no'] + '\', \'open\', \'1200\', \'500\', \'scrollbars=yes, status=no\');">'+cellVal+'</a>';										
			return linkURL;
		}
		...
		function fn_f9(){
			CenterOpenWindow('/partner/coopCompPop?vendor_typ=3', 'open', '1200', '680', 'scrollbars=yes, status=no');
		}
