...
//			},
		...
		$("#btnUpdate").on("click",function(){
			saveGridSelected("list1", 'selected', 'save', "/ve/or/VEOR05/update");
		});
	...
	function linkFormatter(cellVal, options, rowObj) {
		var linkURL = '';
 		linkURL += '<a href="javascript:CenterOpenWindow(\'/ve/or/VEOR05/popup' + '?ord_no=' + rowObj['ord_no'] + '\', \'open\', \'1280\', \'780\', \'scrollbars=yes, status=no\');">';
