	...
	$(document).ready(function() {
		...
		// 그리드 - 프로토타입 
		jQuery('#list1').jqGrid({
			url: '/ve/or/VEOR08/getTransportList',
			datatype: 'local',
...
//			},
	...
	function linkFormatter(cellVal, options, rowObj) {	
 		var linkURL = '<a href="/ve/or/VEOR09/page?tp_no=' + rowObj['tp_no'] + '&screen_id=VEOR09&menu_nm=도착현황상세&js_url=/ve/or/VEOR09">' + cellVal + '</a>';
		return linkURL;
	}
